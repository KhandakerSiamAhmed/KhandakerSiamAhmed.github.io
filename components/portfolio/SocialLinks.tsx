...
export default function SocialLinks({ socials }: Props) {
    ...
    return (
        <>
            ...
            {socials.grabcad && (
                <a href={socials.grabcad} target="_blank" rel="noopener noreferrer" className="social-link" aria-label="GrabCAD">
            ...
            {socials.email && (
                <a href={`mailto:${socials.email}`} className="social-link" aria-label="Email">
